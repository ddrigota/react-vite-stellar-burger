    ...
    >
      <div className={styles.order__container}>
        <div className={styles.order__data}>
          <p
            className={`${styles.order__number} text text_type_digits-default`}
          >{`#${order.number}`}</p>
          <p
            className={`${styles.order__date} text text_type_main-default text_color_inactive`}
          >
            <FormattedDate date={new Date(order.createdAt)} /> i-GMT+3
          </p>
        </div>
        <h2 className={`${styles.order__title} text text_type_main-medium`}>
          {order.name}
        </h2>
        {showStatus ? (
          <p
        ...
        <div className={styles.ingredients__container}>
          ...
          <div className={styles.price}>
            <p className="text text_type_digits-default">
              {calculatePrice(order, allIngredients)}
            </p>
